...
namespace CovidWebService.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            //Simular dois users
            User x0 = new User() { Id = 1, Name = "francisco", Pass = "arantes", Role = Roles.Admin };
            User x1 = new User() { Id = 2, Name = "miguel", Pass = "domingues", Role = Roles.User };
            User x2 = new User() { Id = 3, Name = "ze", Pass = "cunha", Role = Roles.User };
